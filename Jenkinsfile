            ...
            steps {
                ...
                catchError(buildResult: 'SUCCESS', stageResult: 'UNSTABLE') {
                    sh '''
                        ...
                        cd lab6
                        timeout 60 locust --headless --users 1 --spawn-rate 1 --run-time 30s --host=https://localhost:2443 OpenBmcUser > ../locust_results.txt 2>&1 || echo "Locust tests finished with exit code: $?"
